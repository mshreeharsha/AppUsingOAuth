...
const Card = ({blog}) => {
  return (
        <div classname="card" style={{ 'width':'370px','minHeight':'150px','border':'2px grey solid','padding':'10px','paddingBottom':'0px','margin':'10px','display':'flex','flexDirection':'row','backgroundColor':'#FED9ED'}}>
