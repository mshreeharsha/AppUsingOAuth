...
const Card = ({blog}) => {
  return (
        <div classname="card" style={{ 'width':'350px','minHeight':'150px','border':'2px grey solid','padding':'10px','paddingBottom':'0px','margin':'20px','display':'flex','flexDirection':'row','backgroundColor':'#FED9ED'}}>
